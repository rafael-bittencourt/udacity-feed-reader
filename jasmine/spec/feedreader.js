    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        */
        ...
        it('has at least one element showing', function() {
            var nEntries = $('.feed .entry').length;
    ...
    describe('New Feed Selection', function() {
        ...
        */
        var entries, newEntry, oldEntry;

        beforeEach(function(done) {
            loadFeed(0, done);
        });

        it('updates when feed is loaded', function(done) {
            entries = $('.entry');
            oldEntry = entries[0].innerText;
            loadFeed(1, function(){
                entries = $('.entry');
                newEntry = entries[0].innerText;
